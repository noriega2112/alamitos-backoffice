          ...
          <div className="col-lg-8">
            ...
            <div className="card mb-3 shadow-sm">
              <div className="card-body">
                ...
                <div className="form-check mb-2">
                  <input className="form-check-input" type="radio" id="delivery" value="delivery"
                    checked={deliveryType === 'delivery'} onChange={e => setDeliveryType(e.target.value)} />
                  <label className="form-check-label" htmlFor="delivery">🚚 Entrega a domicilio</label>
                </div>
                <div className="form-check">
                  <input className="form-check-input" type="radio" id="pickup" value="pickup"
                    checked={deliveryType === 'pickup'} onChange={e => setDeliveryType(e.target.value)} />
                  <label className="form-check-label" htmlFor="pickup">🏪 Pasar recogiendo</label>
                </div>
              </div>
            </div>
            ...
            <div className="card mb-3 shadow-sm">
              <div className="card-body">
                ...
                <div className="mb-0">
                  <label className="form-label" htmlFor="phoneNumber">Teléfono (8 dígitos) *</label>
                  <input id="phoneNumber" type="tel" className="form-control"
            ...
            {deliveryType === 'delivery' && (
              <div className="card mb-3 shadow-sm">
                <div className="card-body">
                  ...
                  <div className="mb-3">
                    <label className="form-label" htmlFor="zone">Zona *</label>
                  ...
                  <div className="mb-0">
                    <label className="form-label" htmlFor="address">Dirección específica *</label>
            ...
            <div className="card mb-3 shadow-sm">
              <div className="card-body">
                <label className="form-label" htmlFor="notes">Notas adicionales (opcional)</label>
            ...
            <div className="card mb-3 shadow-sm">
              <div className="card-body">
                ...
                {paymentFile && (
                  <p className="text-success small mt-2 mb-0">✓ {paymentFile.name}</p>
                )}
              </div>
            </div>
          </div>
                ...
                {items.map(item => (
                  <div key={item.id} className="d-flex justify-content-between mb-2 small">
                    ...
                    <span className="text-nowrap">
                      L. {((item.itemData.sale_price || item.itemData.price) * item.quantity).toFixed(2)}
                    </span>
                  </div>
                ))}
                <hr />
