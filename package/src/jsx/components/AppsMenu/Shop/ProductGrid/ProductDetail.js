                    ...
                    <div className="new-arrival-content pr">
                      ...
                      <div className="d-flex align-items-end flex-wrap mt-4">
                        <div className="filtaring-area me-3">
                          <div className="size-filter">
                            ...
                            <div className="btn-group" data-toggle="buttons">
                              <label
                                className={
                                  classnames({ active: activeTab === '1' }) + ' btn btn-outline-primary light '
                                }
                                onClick={() => {
                                  toggle('1');
                                }}
                              ...
                              <label
                                className={
                                  classnames({ active: activeTab === '2' }) + ' btn btn-outline-primary light '
                                }
                                onClick={() => {
                                  toggle('2');
                                }}
                              ...
                              <label
                                className={
                                  classnames({ active: activeTab === '3' }) + ' btn btn-outline-primary light '
                                }
                                onClick={() => {
                                  toggle('3');
                                }}
                              ...
                              <label
                                className={
                                  classnames({ active: activeTab === '4' }) + ' btn btn-outline-primary light b'
                                }
                                onClick={() => {
                                  toggle('4');
                                }}
                              ...
                              <label
                                className={
                                  classnames({ active: activeTab === '5' }) + ' btn btn-outline-primary light '
                                }
                                onClick={() => {
                                  toggle('5');
                                }}
                        ...
                        <div className="shopping-cart  mb-2 me-3">
                          <Link className="btn btn-primary" to="/ecom-product-detail">
